%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                                          %
%   This code computes the Endemic Equilibrium of No-Vector-Control Warwick HAT model.     %
%                                                                                          %
%   Inputs:                                                                                %
%       N_H - human population size                                                        %
%       FittedParas - structure containing all parameters (both fixed and fitted)          %
%   Outputs:                                                                               %
%       meff - use the relation Paras.R0^2 ~ meff to get meff for the given Paras.R0       % 
%       ICs - the endemic equilibrium of given parameters                                  %
%                                                                                          %
%   ICs will be used as the initial conditions to run the HAT dynamics for computing       %
%   the Likelihood of Sampling Parameters generated by MCMC algorithm.                     %
%                                                                                          %
