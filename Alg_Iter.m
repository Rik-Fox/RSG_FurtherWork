    ...
    for hz = 1:HZ_N
        ...
        for post_itr = 1:post_itr_N
            ...
            for scr = 1:scr_N
                ...
                Data_20 = Screening_Projection(struct('Years', load_Data.YEAR, 'N_H', load_Data.PopSize(loc_idx), 'PopSizeYear', load_Data.PopSizeYear, 'PeopleScreened', load_Data.SCREENED(loc_idx, :)), load_Data.YEAR(end) + 1:2020, scrname);
                ...
                [ClassesODE0, AggregateODE0] = ODEHATmodel(meff, Data_ICs, Data_50, Paras, ProjStrat);
