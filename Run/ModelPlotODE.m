...
save("Class_dataODEmini/Classes_"+string(Algor_type(itr))+"_"+hzname+'_'+intervention.scrname+'_'+string(Algor_varient(itr))+".mat",'Classes');
save("Agg_dataODEmini/Aggregate_"+string(Algor_type(itr))+"_"+hzname+'_'+intervention.scrname+'_'+string(Algor_varient(itr))+".mat",'Aggregate');
save("intervent_dataODEmini/intervention_"+string(Algor_type(itr))+"_"+hzname+'_'+intervention.scrname+'_'+string(Algor_varient(itr))+".mat",'intervention');
%%
