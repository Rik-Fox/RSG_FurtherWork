...
load('Posteriors/Output_MCMC_M4_DRC_P1_Z51_YasaBonga_ID0002.mat','posterior','fitted_para_names')
post = posterior(pst,:);
...
Specificity = Algors.MeanSpec(itr);
Sensitivity = Algors.MeanSens(itr);
